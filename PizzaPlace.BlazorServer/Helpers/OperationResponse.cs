...
{
    /// <summary>
    /// Enumerates the possible results of an operation.
    /// </summary>
    public enum OperationResult
    {
        ...
        Fail,
        /// <summary>Indicates that the requested item was not found.</summary>
        NotFound
    }
    ...
    public class OperationResponse
    {
        ...
        // Create a Function that will check if the Data is null, if it is not return Ok, if it is return Fail
    ...
    public class OperationResponse<T> : OperationResponse
    {
        ...
        public static OperationResponse<T> CreateDataResponse(T data, string success_message = "Success", string not_found_message = "Not Found", string fail_message = "Fail")
        {
            ...
            {
                return OperationResponse<T>.Fail(fail_message);
            }
        }
